...
void next()
{
  ...
  if(i==2)
  {
    ...
    enqueuecommands_P((PSTR("G1 Y270 F5000"))); // Coordinated Movement X:30mm Y:270mm
    enqueuecommands_P((PSTR("G1 F200 Z-3"))); // Coordinated Movement Z -3mm
  }
  if(i==3)
  {
    enqueuecommands_P((PSTR("G1 F200 Z3"))); // Coordinated Movement Z 3mm
    enqueuecommands_P((PSTR("G1 X270 F5000"))); // Coordinated Movement X:270mm Y:270mm
    enqueuecommands_P((PSTR("G1 F200 Z-3"))); // Coordinated Movement Z -3mm
  }
  if(i==4)
  {
    enqueuecommands_P((PSTR("G1 F200 Z3"))); // Coordinated Movement Z 3mm
    enqueuecommands_P((PSTR("G1 Y30 F5000"))); // Coordinated Movement X:270mm Y:30mm
    enqueuecommands_P((PSTR("G1 F200 Z-3"))); // Coordinated Movement Z -3mm
  }
  if(i==5)
  {
    enqueuecommands_P((PSTR("G1 F200 Z3"))); // Coordinated Movement Z 3mm
    enqueuecommands_P((PSTR("G1 X150 Y150 F5000"))); // Coordinated Movement X:150mm Y:150mm
    enqueuecommands_P((PSTR("G1 F200 Z-3"))); // Coordinated Movement Z -3mm
  }
  if(i==6)
  {
